...
class TweenMaxVars
{
    ...
    /**
		 ...
		 */
    public function bevelFilter(distance : Float = 4, angle : Float = 45, highlightColor : Int = 0xFFFFFF, highlightAlpha : Float = 0.5, shadowColor : Int = 0x000000, shadowAlpha : Float = 0.5, blurX : Float = 4, blurY : Float = 4, strength : Float = 1, quality : Int = 2, remove : Bool = false, addFilter : Bool = false, index : Int = -1) : TweenMaxVars
    {
        var filter : Dynamic = {
            distance : distance,
            angle : angle,
...
TweenMax.to(mc, 3, new TweenMaxVars().bezier([{x:250, y:50}, {x:500, y:0}])); //makes my_mc travel through 250,50 and end up at 500,0.
 ...
 TweenMax.to(mc, 1, new TweenMaxVars().colorMatrixFilter(0xFF0000));
		 ...
		 * @return The TweenMaxVars instance
		 */
    public function colorMatrixFilter(colorize : Int = 0xFFFFFF, amount : Float = 1, saturation : Float = 1, contrast : Float = 1, brightness : Float = 1, hue : Float = 0, threshold : Float = -1, remove : Bool = false, addFilter : Bool = false, index : Int = -1) : TweenMaxVars
    {
        var filter : Dynamic = {
    ...
    /**
		 ...
		 * @return The TweenMaxVars instance
		 */
    public function colorTransform(?tint : Float, ?tintAmount : Float, ?exposure : Float , ?brightness : Float, ?redMultiplier : Float, ?greenMultiplier : Float, ?blueMultiplier : Float, ?alphaMultiplier : Float, ?redOffset : Float, ?greenOffset : Float, ?blueOffset : Float, ?alphaOffset : Float) : TweenMaxVars
    {
		if(tint == null){
			tint = Math.NaN;
		}
    ...
    /**
		 ...
		 * @return The TweenMaxVars instance
		 */
    public function dropShadowFilter(distance : Float = 4, blurX : Float = 4, blurY : Float = 4, alpha : Float = 1, angle : Float = 45, color : Int = 0x000000, strength : Float = 2, inner : Bool = false, knockout : Bool = false, hideObject : Bool = false, quality : Int = 2, remove : Bool = false, addFilter : Bool = false, index : Int = -1) : TweenMaxVars
    {
        var filter : Dynamic = {
            distance : distance,
            blurX : blurX,
 ...
 TweenMax.to(mc, 1, new TweenMaxVars().frame(125)); 
    ...
    /**
		 ...
		 * @return The TweenMaxVars instance
		 */
    public function glowFilter(blurX : Float = 10, blurY : Float = 10, color : Int = 0xFFFFFF, alpha : Float = 1, strength : Float = 2, inner : Bool = false, knockout : Bool = false, quality : Int = 2, remove : Bool = false, addFilter : Bool = false, index : Int = -1) : TweenMaxVars
    {
        var filter : Dynamic = {
            blurX : blurX,
            blurY : blurY,
 ...
 TweenMax.to(myComponent, 1, new TweenMaxVars().setSize(200, 30)); 
		 ...
		 **/
    public function setSize(?width : Float, ?height : Float) : TweenMaxVars
    {
